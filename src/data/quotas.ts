...
export const initialQuotas: QuotaRule[] = [
  // ── Exceeded / near-limit (used >= 80%) ───────────────────────────────────
  {
    ...
    metric: "tokens",
    limit: 5_000_000,
    used: 5_210_000,          // 104% — breached
    period: "day",
    action: "throttle",
    environment: "production",
    updatedAt: "2026-05-22T10:24:00Z",
  },
  {
    id: "q-2",
  ...
  },
  {
    ...
    metric: "requests",
    limit: 500,
    used: 512,                 // 102% — breached
    period: "hour",
    action: "block",
    environment: "production",
    updatedAt: "2026-05-22T14:02:00Z",
  },
  {
    id: "q-8",
  ...
  {
    id: "q-9",
    name: "Finance — Salesforce API calls",
    description: "Daily cap on Salesforce CRM requests from Finance area.",
    enabled: true,
    scopeKind: "area",
    scopeId: "area:finance",
    scopeLabel: "Finance",
    targetKind: "api",
    targetId: "api:salesforce",
    targetLabel: "Salesforce",
    metric: "requests",
    limit: 2_000,
    used: 1_960,               // 98% — near limit
    period: "day",
    action: "warn",
    environment: "production",
  ...
  {
    id: "q-10",
    name: "Support — daily executions",
    description: "Cap on orchestration runs for the support team.",
    enabled: true,
    scopeKind: "team",
    scopeId: "team:support",
    scopeLabel: "Support",
    targetKind: "flow",
    targetId: "*",
    targetLabel: "Any flow",
    metric: "executions",
    limit: 1_000,
    used: 870,                 // 87% — near limit
    period: "day",
    action: "throttle",
    environment: "production",
  ...
  {
    id: "q-5",
    name: "Operations — memory cap",
    description: "Memory limit for operations workloads.",
    enabled: true,
    scopeKind: "area",
    scopeId: "area:operations",
  ...
  {
    id: "q-6",
    name: "Growth — invoice extractor executions",
    enabled: true,
    scopeKind: "team",
    scopeId: "team:growth",
    scopeLabel: "Growth",
    targetKind: "flow",
    targetId: "flow:invoice-extractor",
    targetLabel: "Invoice Extractor",
    metric: "executions",
    limit: 500,
    used: 210,
    period: "month",
