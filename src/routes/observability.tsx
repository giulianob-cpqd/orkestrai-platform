...
export const Route = createFileRoute("/observability")({
  head: () => ({ meta: [{ title: "Observability · Synapse" }] }),
...
const traces = [
  ...
  { id: "tr_8a91ed", agent: "Researcher", duration: "2.9s", tokens: "3.5k", status: "ok", time: "1m ago" },
];
...
function ObservabilityPage() {
  return (
    <AppLayout title="Observability" subtitle="Metrics, logs and distributed traces">
      <div className="space-y-6 p-6">
        <PageHeader title="Observability" description="Live insight into your agent runtime." />
          ...
          <Card className="border-border bg-card/80 p-4 backdrop-blur-md lg:col-span-2">
            ...
            <ResponsiveContainer width="100%" height={240}>
              <AreaChart data={latencyData}>
                ...
                <Area type="monotone" dataKey="p50" stroke="oklch(0.82 0.17 180)" fill="url(#g50)" strokeWidth={2} />
                <Area type="monotone" dataKey="p99" stroke="oklch(0.7 0.18 300)" fill="url(#g99)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </Card>
