...
import { Send, Brain, MemoryStick, Database, Wrench, Server } from "lucide-react";
...
export const Route = createFileRoute("/agent-builder")({
  head: () => ({
    meta: [
      { title: "Agent Builder · Synapse" },
      { name: "description", content: "Compose individual agents with LLMs, RAG, memory, tools and MCP servers." },
    ],
  }),
...
function AgentBuilderPage() {
  return (
    <AppLayout
      ...
      subtitle="Single agent definition · v0.3.1"
      actions={
        <>
