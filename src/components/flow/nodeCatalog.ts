...
export const agentNodeCatalog: NodeTemplate[] = [
  { type: "input", variant: "input", label: "Prompt Input", description: "Incoming user message", icon: "Send", meta: "text · multimodal" },
...
export const orchestrationNodeCatalog: NodeTemplate[] = [
  { type: "endpoint", variant: "endpoint", label: "Endpoint", description: "REST · gRPC · WS · GraphQL", icon: "Webhook", meta: "POST /v1/chat" },
  ...
  { type: "queue", variant: "queue", label: "Topic / Queue", description: "Kafka · RabbitMQ · NATS", icon: "Radio", meta: "events.user.created" },
  { type: "db", variant: "db", label: "Database", description: "Postgres · Mongo · Redis", icon: "Database", meta: "select · upsert" },
  ...
  { type: "output", variant: "output", label: "Response Sink", description: "Stream back to caller", icon: "Send", meta: "SSE · WS" },
];
